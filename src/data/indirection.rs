...
/// Resolve an entity ID to its path by traversing up the parent chain (Store version)
...
/// Resolve a path to an entity ID by traversing down from the root (Store version)
